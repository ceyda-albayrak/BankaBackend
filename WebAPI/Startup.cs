...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors();
            services.AddScoped<EfMusteriDal>();
            services.AddScoped<EfHesapDal>();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebAPI", Version = "v1" });
            });
            services.AddSingleton<IHesapService, HesapManager>();
            services.AddSingleton<IHesapDal, EfHesapDal>();
